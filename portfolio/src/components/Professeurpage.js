...
const ProfessorPage = () => {
  const [students, setStudents] = useState([
    { id: 1, name: 'Eleve 3e', grade: 0 },
    { id: 2, name: 'Élève 3e', grade: 0},
    { id: 3, name: 'Élève 3e', grade: 0 },
    { id: 4, name: 'Élève 3e', grade: 0},
    { id: 5, name: 'Élève 3e', grade: 0 },
    { id: 6, name: 'Élève 3e', grade: 0 },
    { id: 7, name: 'Élève 3e', grade: 0 },
    { id: 8, name: 'Élève 3e', grade: 0 },
    // ... Ajoutez d'autres élèves ici
  ]);

  const [selectedClass, setSelectedClass] = useState('3e');
