...
function Home() {
  return (
    ...
    <form action="" method="POST" className="w-full md:w-1/2 lg:w-1/3 p-8 md:p-12 bg-white rounded-md shadow-lg">
      <div className="mb-4">
        <label htmlFor="nom" className="block font-bold text-black">Nom :</label>
        <input type="text" id="nom" placeholder="Entrer votre Nom" name="nom" className="border-2 rounded border-black px-2 py-1 w-full" />
      </div>
      <div className="mb-4">
        <label htmlFor="prenom" className="block font-bold text-black">Prenom :</label>
        <input type="text" id="prenom" placeholder="Entrer votre Prenom" name="prenom" className="border-2 rounded border-black px-2 py-1 w-full" />
      </div>
      <div className="mb-4">
