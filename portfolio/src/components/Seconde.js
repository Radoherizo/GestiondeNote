...
const Seconde = () => {
  const [students, setStudents] = useState([
    { id: 1, name: 'Eleve 2nde', grade: 0 },
    { id: 2, name: 'Eleve 2nde', grade: 0 },
    { id: 3, name: 'Eleve 2nde', grade: 0 },
    { id: 4, name: 'Eleve 2nde', grade: 0 },
    { id: 5, name: 'Eleve 2nde', grade: 0 },
    { id: 6, name: 'Eleve 2nde', grade: 0 },
    { id: 7, name: 'Eleve 2nde', grade: 0 },
    { id: 8, name: 'Eleve 2nde', grade: 0 },
    // ... Ajoutez d'autres élèves ici
  ]);

  const [selectedClass, setSelectedClass] = useState('2nde');
